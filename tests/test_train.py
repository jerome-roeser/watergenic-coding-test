...
class TestTrainModel(unittest.TestCase):
    ...
    def test_model_is_not_none(self):
        ...
        self.assertIsInstance(
            model, type(train_model(self.df, mlflow_tracking_server=False)[0])
        )
...
class TestFileInput(unittest.TestCase):
    ...
    def test_invalid_csv_input(self):
        ...
        with self.assertRaises(ValueError):
            self.runner.invoke(
                main, ["--input_file", input_file], catch_exceptions=False
            )
...
class TestMlflow(unittest.TestCase):
    ...
    def test_mlflow_experiment_exists(self):
        ...
        self.assertIsNotNone(experiment_id, "Experiment should exist")
